/*
Quadruplets:
Given four vectors of N integer values, computes how many
quadruplets (one element from every vector) form a total sum of zero.

Input:
The first line of the standard input will contain:
N - the length of the list N; 1 <= N <= 700
Each of the following 4 lines will contain
N space-separated integers which represent the vectors.

Output:
On a single line on the standard output, print a single integer
indicating the number of quadruplets whose total sum is zero.
*/
#include <iostream>
#include <string>
#include <vector>
