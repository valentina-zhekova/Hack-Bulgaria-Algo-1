...
The first line of the input will contain N - the number size of the map. The second line will contain 4 integers RowStart,ColumnStart and RowFinish, ColumnFinish - the zero-based coordinates of the start and the finish on the map. The next N lines will each contain N integers representing the altitude of the corresponding cell in the map.

Output

Output the minimal possible time in which you can run from the start to the finish.
